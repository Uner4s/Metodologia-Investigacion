...
int pos; // Posiciones avanzadas para crear el arbol;
/*
...
void *encontrar_hijo_izquierda(void*){// Funcion que encuentra el hijo de la izquierda segun la fraccion actual del arbol
...
void *encontrar_hijo_derecha(void*){// Funcion que encuentra el hijo de la derecha segun la fraccion actual del arbol
	unsigned long int  posicion;
...
int main(int argc, char *argv[]){
	unsigned long int cantidad_nodos = 0; // Numero de nodos que podra crear el programa.
	...
	ofstream Archivo2;
	Archivo2.open("ArbolParalelo.dat",std::ios_base::app);
	...
	pthread_create(&id,NULL,encontrar_hijo_izquierda,NULL); // Funcion que genera el hijo de la izquierda de un nodo
	pthread_create(&id2,NULL,encontrar_hijo_derecha,NULL);	// Funcion que genera el hijo de la derecha de un nodo.
